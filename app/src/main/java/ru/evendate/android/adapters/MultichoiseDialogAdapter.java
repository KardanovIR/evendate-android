 ...
 */
public class MultichoiseDialogAdapter extends ArrayAdapter<EventNotification> {
        private final Context context;
        private final ArrayList<EventNotification> values;

        public MultichoiseDialogAdapter(Context context, ArrayList<EventNotification> values) {
